document.addEventListener('DOMContentLoaded', function(){
    ...
    const toggleAnswer = (questionIcon) => {
        ...
        questionIcon.src = (questionIcon.src === "https://github.com/marviecephas/faq-accordion/blob/main/icon-plus.svg") ? "https://github.com/marviecephas/faq-accordion/blob/icon-minus.svg" : "https://github.com/marviecephas/faq-accordion/blob/icon-plus.svg";
